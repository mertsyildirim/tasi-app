...
export default function ExpressPage() {
  ...
  const handleContinue = () => {
    ...
    if (!hasError) {
      ...
      setTimeout(() => {
        localStorage.setItem('expressDelivery', JSON.stringify({
          pickup,
          delivery,
          distance,
          duration,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="bg-blue-500 text-white p-6">
            ...
            <p className="mt-2">Acil gönderileriniz için hızlı ve öncelikli taşıma hizmeti.</p>
          </div>
          ...
          <div className="p-6">
            <div className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                Alış ve teslimat noktalarını seçerek express taşıma hizmetimizden hemen yararlanmaya başlayın.
              </p>
                    ...
                    <Autocomplete onLoad={onPickupLoad} onPlaceChanged={onPickupPlaceChanged}>
                      <div>
                        <input
                          ...
                          className={`w-full px-4 py-2 border ${pickupError ? 'border-red-300' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500`}
                        />
                    ...
                    <Autocomplete onLoad={onDeliveryLoad} onPlaceChanged={onDeliveryPlaceChanged}>
                      <div>
                        <input
                          ...
                          className={`w-full px-4 py-2 border ${deliveryError ? 'border-red-300' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500`}
                        />
              ...
              <div className="border-t pt-6 mb-8">
                <h3 className="text-lg font-semibold mb-4">Express Taşıma Avantajları</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h4 className="text-base font-medium">Hızlı Teslimat</h4>
                      <p className="mt-1 text-sm text-gray-500">Aynı gün içinde hızlı teslimat garantisi</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h4 className="text-base font-medium">Öncelikli Hizmet</h4>
                      <p className="mt-1 text-sm text-gray-500">Diğer gönderilerden önce işleme alınır</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-1 text-sm text-gray-500">Gönderileriniz tam değerinde sigortalanır</p>
                    </div>
                  </div>
                </div>
              </div>
