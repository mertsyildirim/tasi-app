...
import { 
  FaTruck, FaClock, FaMapMarkedAlt, FaBoxOpen, FaPallet, 
  FaShieldAlt, FaArrowLeft, FaSpinner, FaWarehouse 
} from 'react-icons/fa'
import { 
  useLoadScript, 
  GoogleMap, 
...
export default function PaletPage() {
  ...
  const [paletWeight, setPaletWeight] = useState(500)
  const [paletType, setPaletType] = useState('euro') // euro, industry, custom
