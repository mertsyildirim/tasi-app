    ...
    <main className={`min-h-screen bg-gray-100 flex flex-col ${showModal || showSummaryModal || showPhoneModal || showSearchingModal || showWaitingApprovalModal || showCarrierDetailsModal || showPaymentModal || showPaymentSuccessModal ? 'modal-blur' : ''}`}>
        ...
        <nav className="bg-white shadow-md py-4">
          <div className="container mx-auto px-4 flex justify-between items-center">
            ...
            <div className="hidden md:flex space-x-6 items-center">
              ...
              <a href="#" className="text-gray-600 hover:text-orange-600 transition group relative">
                İletişim
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-orange-500 transition-all duration-300 group-hover:w-full"></span>
              </a>
              ...
              <Link href="/portal/dashboard" className="bg-orange-100 text-orange-600 px-4 py-2 rounded-lg hover:bg-orange-200 transition">Taşıyıcı Girişi</Link>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="#" className="text-gray-400 hover:text-orange-500 transition group relative inline-block">
                    Anasayfa
                    <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-orange-500 transition-all duration-300 group-hover:w-full"></span>
                  </a>
                </li>
                <li>
                  <a 
                    href="#services" 
                    onClick={handleServicesClick}
                    className="text-gray-400 hover:text-orange-500 transition group relative inline-block"
                  >
                    Hizmetlerimiz
                    <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-orange-500 transition-all duration-300 group-hover:w-full"></span>
                  </a>
                ...
                <li>
                  <a href="#features" className="text-gray-400 hover:text-orange-500 transition group relative inline-block">
                    Neden Biz?
                    <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-orange-500 transition-all duration-300 group-hover:w-full"></span>
                  </a>
                </li>
      ...
      {showPhoneModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 w-full max-w-md">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold">Telefon Numarası</h2>
            </div>
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
